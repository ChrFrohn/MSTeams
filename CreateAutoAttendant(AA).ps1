...
$DisplayNameForAA = "" #What you want to be displayed to users
...
$Combined = "$DisplayNameForAA@$Domain.onmicrosoft.com"
...
Set-CsOnlineApplicationInstance -Identity $Combined -OnpremPhoneNumber $PhoneNumber 
